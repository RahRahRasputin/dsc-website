...
# Paths
wiki_source = Path("/sessions/compassionate-gallant-pasteur/mnt/Machine Learning Knowledge Garden/wiki/empirical-practice")
website_dest = Path("/sessions/compassionate-gallant-pasteur/mnt/Machine Learning Knowledge Garden/website/empirical-practice")
website_dest.mkdir(parents=True, exist_ok=True)

# Silo definitions
silo = "Empirical Practice"
silo_name = "Empirical Practice"
...
def extract_soulcraft_theme(content):
    ...
    if "experiment" in content.lower() or "empirical" in content.lower():
...
# Main conversion
print("Converting Empirical Practice entries...")
entries = []
published_count = 0
review_count = 0
...
with open('empirical_practice_entries.json', 'w') as f:
    json.dump(entries, f, indent=2)

print("\nEntry info saved to empirical_practice_entries.json")
