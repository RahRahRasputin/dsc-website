...
# Paths
wiki_source = Path("/sessions/compassionate-gallant-pasteur/mnt/Machine Learning Knowledge Garden/wiki/living-process")
website_dest = Path("/sessions/compassionate-gallant-pasteur/mnt/Machine Learning Knowledge Garden/website/living-process")
website_dest.mkdir(parents=True, exist_ok=True)

# Silo definitions
silo = "Living Process"
silo_name = "Living Process"
...
def extract_soulcraft_theme(content):
    ...
    if "soulcraft" in content.lower() or "learning" in content.lower():
        return "learning-and-process"
    return ""
...
# Main conversion
print("Converting Living Process entries...")
entries = []
published_count = 0
review_count = 0
...
with open('living_process_entries.json', 'w') as f:
    json.dump(entries, f, indent=2)

print("\nEntry info saved to living_process_entries.json")
