...
# Paths
wiki_source = Path("/sessions/compassionate-gallant-pasteur/mnt/Machine Learning Knowledge Garden/wiki/architecture-zoo")
website_dest = Path("/sessions/compassionate-gallant-pasteur/mnt/Machine Learning Knowledge Garden/website/architecture-zoo")
website_dest.mkdir(parents=True, exist_ok=True)

# Silo definitions
silo = "Architecture Zoo"
silo_name = "Architecture Zoo"
...
# Main conversion
print("Converting Architecture Zoo entries...")
entries = []
published_count = 0
review_count = 0
...
with open('architecture_zoo_entries.json', 'w') as f:
    json.dump(entries, f, indent=2)

print("\nEntry info saved to architecture_zoo_entries.json")
